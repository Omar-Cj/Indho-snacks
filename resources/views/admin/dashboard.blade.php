    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="menu_form_category" action="{{url('assignorder')}}" method="post"
                        enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="form-group">
                            <label>{{__('messages.order_id')}}</label>
                            <input type="text" class="form-control" placeholder="{{__('messages.order_id')}}" name="id"
                                id="order_id" readonly>
                        </div>
                        <div class="form-group">
